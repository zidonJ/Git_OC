...
//        });
        ...
        [Lock addObserver:self forKeyPath:@"bb" options:NSKeyValueObservingOptionNew context:nil];
        
    }
    return self;
}

+ (void)setAa:(NSInteger)aa {
    
    [self willChangeValueForKey:@"bb"];
    bb = aa;
    [self didChangeValueForKey:@"bb"];
}
